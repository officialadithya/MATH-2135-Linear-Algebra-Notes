...
\chapter*{}
\addcontentsline{toc}{chapter}{List of Theorems, Definitions, Examples, and Exercises}
\markboth{LIST OF THEOREMS, DEFINITIONS, EXAMPLES, AND EXERCISES}{LIST OF THEOREMS, DEFINITIONS, EXAMPLES, AND EXERCISES}
...
\end{savequote}
    \chapter{Optimization in \(\mathbb{R}^n\) and the Hessian Matrix} \label{appendix:c}
        ...
        \input{Chapters/optimizationHessian.tex}
