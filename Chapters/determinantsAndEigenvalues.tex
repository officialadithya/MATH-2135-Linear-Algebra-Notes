    ...
    \subsection{Eigenvectors, Eigenvalues, and Diagonalization}
        ...
        \begin{theorem}{\Stop\,\,Finding Eigenvectors and Eigenvalues}{findeigenvs}
            ...
            \begin{equation*}
                (A-\lambda I)X=0.
            \end{equation*}
            The above equation has a nonzero solution for \(X\) if and only if 
            \begin{equation*}
                \det(A-\lambda I)=0.
            \end{equation*}
        ...
        \\
        \\
        Note that, for now, we will only consider real eigenvalues; however, complex eigenvalues are incredibly useful and have numerous applications.