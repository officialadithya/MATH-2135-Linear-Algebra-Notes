...
\section{Lecture 15: September 26, 2022}
    ...
    \subsection{Eigenvectors, Eigenvalues, and Diagonalization}
        ...
        \begin{definition}{\Stop\,\,Diagonalizability}{diagonalizability}
            ...
            The matrix \(A\in\mathcal{M}_{nn}\) is diagonalizable if and only if \(A\) is similar to a diagonal matrix. That is, if \(D\) is a diagonal matrix, \(A\) is diagonalizable if and only if
            \begin{equation*}
                A=PDP^{-1}.
            \end{equation*}
...
\section{Lecture 16: September 28, 2022}
    ...
    \subsection{The Process of Diagonalization}
        ...
        \begin{theorem}{\Stop\,\,Diagonalization}{diagonalization}
