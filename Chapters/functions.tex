...
\section{Composition and Inverses}
    ...
    \begin{theorem}{\Stop\,\,Uniqueness of Inverse Functions}{uniqueinv}
        ...
        If \(F:A\to B\) has an inverse \(G:B\to A\), \(G\) is the only inverse of \(F\).
        \begin{proof}
...
\section{The Pigeonhole Principle}
    ...
    \end{example}
    \begin{example}{\Difficulty\,\Difficulty\,\Difficulty\,\,Square}{square}
...
\section{The Cardinalities of Sets}
        ...
        \\
        Consider the following examples.
        \begin{example}{\Difficulty\,\Difficulty\,\,Natural Numbers and Integers}{natint}
            ...
            \begin{proof}
                ...
                \end{equation*}
                We see that \(F\) is a bijection between the two sets.
            \end{proof}
        ...
        \begin{example}{\Difficulty\,\Difficulty\,\,Natural Numbers and Rational Numbers}{natrat}
            ...
            \begin{proof}
                ...
                \begin{center}
                    ...
                    \end{tabular}
                \end{center}
                This method will generate all rational numbers once and only once and is a bijective map from \(\mathbb{N}\) to \(\mathbb{Q}\).
            \end{proof}
